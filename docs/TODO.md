...
按 `docs/REPRODUCTION_PLAN.md` §七 拆 7 批：

- 🔲 **P2-A**：Token 补齐 + 全项目魔数替换（贴皮地基，无视觉改变） ← **当前批次**
- 🔲 P2-B：通用组件抽取（PermissionFlowHelper）+ ListenableBuilder 优化 + ConsumerWidget 降级
- 🔲 P2-C：Noto Sans SC 字体引入 + StandardHomePage / ElderHomePage 贴皮
...
- 🔲 P2-终：测试补齐 + 32 对照截图 + 打 `v1.0-baseline` tag
...
### 2026-04-18 · `<pending>` · docs(phase-2): PM 新增 §七 Phase 2 实施计划（7 批次）
- `docs/REPRODUCTION_PLAN.md` 484–700 行：Phase 2 拆 7 批（A 地基 / B 通用组件 / C 首页 / D 登录 / E 搜索 / F 服务+我的 / 终 验收打 tag）
