...
- 🔲 批次 5：SocialInsurancePage + PensionQueryPage + MyPage ← **下一步（Phase 1 收尾）**
...
- 🔲 在 `CLAUDE.md` 补导航约定：`go` = 流程终结/栈替换；`push` = 子级钻取
...
### 2026-04-18 · `<pending>` · feat(phase-1): 批次 4 — SearchPage + SearchResultPage
