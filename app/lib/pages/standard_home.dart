...
class _ServiceGridSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView.count(crossAxisCount: 4, shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), mainAxisSpacing: Spacing.lg, crossAxisSpacing: Spacing.sm, childAspectRatio: 0.85,
...
class _HotServiceSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Container(color: AppColors.surface, margin: const EdgeInsets.only(top: Spacing.xs), padding: const EdgeInsets.all(Spacing.lg),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text('热门服务', style: TextStyle(fontSize: AppFontSize.bodyLarge, fontWeight: FontWeight.w600)),
        const SizedBox(height: Spacing.md),
        Container(height: 80, color: Colors.grey[200], alignment: Alignment.center, child: const Text('热门服务卡片占位', style: TextStyle(color: AppColors.textSecondary))),
      ]),
    );
  }
}
...
class _BottomNavBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BottomNavigationBar(currentIndex: 2, type: BottomNavigationBarType.fixed, selectedItemColor: AppColors.standardPrimary, unselectedItemColor: Colors.grey,
      items: const [
